...
class icBLM:
    def __init__(self):
        ...
        #The product of the two cannot be more than 15000. (The memorydepth of the keithley)
        ...
        self.kt.write(':charge:adischarge:level 1.0e-6')
...
ic = icBLM()
nMeasurement = 0
while nMeasurement < 121:# 1800/ic.TriggersPerMeasurement: #Important setting - the maximum number of triggers per run
